...
def view_tasks():
    ...
    # if (tasks):
    #     for task in tasks:
    #         task_list.insert(tk.END,f"Task ID: {task[0]}, Task Name: {task[1]}, Description: {task[2]}, Completed: {'Yes' if task[3] else 'No'}")
    # else:
...
def delete_task():
    selected_task = task_list.get(tk.ACTIVE)
    # print(selected_task.split(',')[0])
    # print(selected_task.split(',')[1])
    # print(selected_task.split(',')[2])
    # print(type(selected_task.split(',')[0])) 
...
def refresh_list():
    ...
    tasks = view_tasks()
    for task in tasks:
          task_list.insert(tk.END,f"{task[0]}, Task Name: {task[1]}, Description: {task[2]}")
...
# Project made by Harsh kumar chaurasia
